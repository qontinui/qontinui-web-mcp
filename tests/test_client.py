...
class TestQontinuiClient:
    ...
    def test_is_authenticated(self, mock_client, unauthenticated_client):
...
class TestClientAuth:
    ...
    @pytest.mark.asyncio
    async def test_login_success(self, unauthenticated_client, mock_tokens, mock_user):
    ...
    @pytest.mark.asyncio
    async def test_login_failure(self, unauthenticated_client):
...
class TestClientProjects:
    ...
    @pytest.mark.asyncio
    async def test_update_project(self, mock_client, mock_project):
...
class TestClientWorkflows:
    ...
    @pytest.mark.asyncio
    async def test_get_workflows(self, mock_client, mock_project):
    ...
    @pytest.mark.asyncio
    async def test_add_workflow(self, mock_client, mock_project):
...
class TestClientStates:
    ...
    @pytest.mark.asyncio
    async def test_get_states(self, mock_client, mock_project):
    ...
    @pytest.mark.asyncio
    async def test_add_state(self, mock_client, mock_project):
...
class TestClientErrorHandling:
    ...
    @pytest.mark.asyncio
    async def test_404_raises_not_found(self, mock_client):
    ...
    @pytest.mark.asyncio
    async def test_422_raises_validation_error(self, mock_client):
